...
// Период ресурс
export const LOAD_ALL_PERIOD_RESOURCES_SUCCESS = 'LOAD_ALL_PERIOD_RESOURCES_SUCCESS'
export const LOAD_ALL_PERIOD_RESOURCES_START = 'LOAD_ALL_PERIOD_RESOURCES_START'
export const LOAD_ALL_PERIOD_RESOURCES_FAIL = 'LOAD_ALL_PERIOD_RESOURCES_FAIL'
...
export const LOAD_PERIODS_SUCCESS = 'LOAD_PERIODS_SUCCESS'
export const LOAD_PERIODS_START = 'LOAD_PERIODS_START'
...
export const UPLOAD_USER_IN_RESOURCES = 'UPLOAD_USER_IN_RESOURCES'
export const UPLOAD_USER_IN_RESOURCES_FAIL = 'UPLOAD_USER_IN_RESOURCES_FAIL'
export const ADD_USER_TO_RESOURCE_CANCEL = 'ADD_USER_TO_RESOURCE_CANCEL'

// ЗАгружаем список организация
export const LOAD_ALL_ORGANIZATION_SUCCESS = 'LOAD_ALL_ORGANIZATION_SUCCESS'
export const LOAD_ALL_ORGANIZATION = 'LOAD_ALL_ORGANIZATION'

export const UPLOAD_USER_IN_RESOURCES_START = 'UPLOAD_USER_IN_RESOURCES_START'
export const UPLOAD_RESOURCES_SUCCESS = 'UPLOAD_RESOURCES_SUCCESS'
export const UPLOAD_RESOURCES_FAIL = 'UPLOAD_RESOURCES_FAIL'

export const UPLOAD_RESOURCES_FOR_TRANSPORTATION_SUCCESS = 'UPLOAD_RESOURCES_FOR_TRANSPORTATION_SUCCESS'
